...
- `internal/x/httpx/` — `DoWithRetry` wraps `http.Client.Do` with exponential backoff + jitter. Retries transport errors and 5xx; 4xx are returned as-is. Default 3 attempts (`--retries`).
