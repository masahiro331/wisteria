// Package nuclei fetches the projectdiscovery/nuclei-templates archive.
package nuclei
...
const (
	sourceName        = "nuclei"
	defaultArchiveURL = "https://github.com/projectdiscovery/nuclei-templates/archive/refs/heads/main.tar.gz"
)
...
// Fetcher downloads the nuclei-templates tarball.
type Fetcher struct {
	archiveURL string
	client     *http.Client
	cacheDir   string
